...
function EncryptedData(reader) {
  ...
  // Remove properties
  delete reader.object[IV_JSON];
  delete reader.object[TAG_JSON];
  delete reader.object[CIPHER_TEXT_JSON];
  // Get a "normalized" rather than "canonicalized" JSON string (=signed data).
  this.authenticatedData = reader.getNormalizedData();
  // Restore encryption object
  reader.object = clone; 
