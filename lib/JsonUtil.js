...
function bigDecimalSyntax(string) {
...
function getBigDecimalString(value) {
  return bigDecimalSyntax(getBigString(value));
}
...
ObjectWriter.prototype.setBigDecimal = function(name, value) {
  return this.setString(name, getBigDecimalString(value));
};
...
ArrayWriter.prototype.setBigDecimal = function(value) {
  return this.setString(getBigDecimalString(value));
};
...
ObjectReader.prototype.getBigDecimal = function(name) {
  return new Big(bigDecimalSyntax(this.getString(name)));
};
...
ObjectReader.prototype.getSignature = function() {
  ...
  return new Jcs.Verifier().decodeSignature(this.object);
};
...
ArrayReader.prototype.getBigDecimal = function() {
  return new Big(bigDecimalSyntax(this.getString()))
};
